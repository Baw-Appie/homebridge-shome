...
exports.getDeviceList = async (accessToken) => {
	try {
		var deviceRequestPayload = {
			method: "get",
			url: "https://shome-api.samsung-ihp.com/v16/settings/SHP-HB700M.C0847DADE342/devices/",
			params: {
				createDate: moment().utc().format("YYYYMMDDHHmmss"),
				hashData: "hashData"
			},
		...
		deviceRequestPayload.params.hashData = sha512(`IHRESTAPISHP-HB700M.C0847DADE342${deviceRequestPayload.params.createDate}`)
