...
export const getDeviceInfoList = async (accessToken, type, thngId) => {
	try {
		var requestPayload = {
			method: "get",
...
export const setDevice = async (accessToken, thngId, active, deviceId, type, thngType) => {
	try {
		var requestPayload = {
			method: "put",
...
export const unlockDoorlock = async (accessToken, thngId) => {
	try {
		var requestPayload = {
			method: "put",
